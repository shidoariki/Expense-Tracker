  ...
  try {
    ...
    if (existingExpenses.length === 0) {
      await prisma.expense.createMany({
        data: [
          { amount: 500, category: 'Food', description: 'Lunch at restaurant', userId: 1 },
          { amount: 1000, category: 'Transport', description: 'Uber to office', userId: 1 },
          { amount: 250, category: 'Snacks', description: 'Coffee break', userId: 1 }
        ],
        skipDuplicates: true
      });
